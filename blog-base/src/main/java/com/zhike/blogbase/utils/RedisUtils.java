 ...
 * <p>
 * RedisUtils at 2022/1/16 21:20,code by JeffreyHu
...
//    private RedisTemplate redisTemplate;
    ...
    public <T> List<T> lGet(String key, long start, long end, Class<T> type) {
        try {
            List<Object> elements = redisTemplate.opsForList().range(key, start, end);
            return JSON.parseArray(JSON.toJSONString(elements), type);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
