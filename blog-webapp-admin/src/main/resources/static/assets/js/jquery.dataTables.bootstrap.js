  ...
  $.extend($.fn.dataTableExt.oPagination, {
    "bootstrap": {
      "fnInit": function (oSettings, nPaging, fnDraw) {
        ...
        var pagingHTMLI18n = '<ul class="pagination">' +
						'<li class="prev disabled"><a href="#">' + oLang.sFirst + '</a></li>' +//first
						'<li class="prev disabled"><a href="#">' + oLang.sPrevious + '</a></li>' +//prev
						'<li class="next disabled"><a href="#">' + oLang.sNext + '</a></li>' +//next
						'<li class="next disabled"><a href="#">' + oLang.sLast + '</a></li>' +//last
					'</ul>'

        $(nPaging).append(pagingHTMLI18n);
